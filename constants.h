...
#define DEFAULT_MONITOR_SOCKET_NAME "za.co.csir.walkiemesh.servald.monitor.socket"
#define DEFAULT_MDP_SOCKET_NAME "za.co.csir.walkiemesh.servald.mdp.socket"
